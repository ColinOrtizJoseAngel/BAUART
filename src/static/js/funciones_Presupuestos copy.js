...
function añadirConcepto() {
  ...
  cell1.innerHTML = `
    <input type="number" class="form-control borderless" style="text-align: center" id="ID_DETALLE[]" name="ID_DETALLE[]" readonly>
`;
  ...
  cell3.innerHTML = `
  <input type="text" class="form-control" style="text-align: left" id="INPUT_PROVEEDOR" name="PROVEEDOR[]" autocomplete="off" required>
...
`;
  ...
  cell4.innerHTML = `
  <input type="text" class="form-control currency-input presupuesto-cliente" name="PRESUPUESTO_CLIENTE[]" onblur="concular_diferecnia()">
`;

  cell5.innerHTML = `
  <input type="text" class="form-control currency-input presupuesto-proveedor"  name="PRESUPUESTO_PROVEEDOR[]" onblur="concular_diferecnia()">
`;

  cell6.innerHTML = `
    <input type="text" class="form-control currency-input presupuesto-diferencia" name="DIFERENCIA[]" readonly>
`;
...
<div class="d-flex align-items-center justify-content-center">
  <button onclick="eliminarFila(this)" class="btn btn-danger"><i class="bi bi-trash"></i></button>
</div>
`;
